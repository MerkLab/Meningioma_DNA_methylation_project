...
#####start working on discovery cohort
###get discovery cohort survival data with all predictors
...
setwd(here("results"))
cairo_pdf(filename = "c-indices.pdf", width = 9, height = 5)
...
cairo_pdf(filename = "RCS_gradient.pdf", width = 9, height = 5)
