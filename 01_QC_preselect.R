...
idat_dir = here("data", "cohort_preselect")
list.files(idat_dir)
...
idat_dir = here("data", "cohort_preselect")
list.files(idat_dir)
setwd(here("data", "cohort_preselect"))
...
targets <- read.metharray.sheet(here("data", "general_datasets", "meta_discovery_current.csv"))
...
idat_dir = here("data", "GSE304094")
list.files(idat_dir)
meta_discovery = read.csv(here("data", "general_datasets", "meta_discovery_current.csv"))

#Sesame QC pipeline for detection success
