...
idat_dir = here("data", "GSE183656")
list.files(idat_dir)
meta_Raleigh = read.csv(file="meta_UCSF_current.csv")
...
###get discovery data that is already pre-processed, only complete case probes, that match EPIC probes
setwd(here("data", "general_datasets"))
...
list.files(idat_dir)
setwd(here("data", "general_datasets"))
meta_long = read.csv(file="meta_longitudinal_current.csv")
